...
discussion. That state changes in meetings, Notion and GitHub between
sessions, and a stale memory reads as authoritative.
...
describes the code, the relevant Notion page or GitHub issue when it
describes the plan.
